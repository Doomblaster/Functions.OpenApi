...
|-----------|----------|----------|
| Library code, builders, schemas, attributes | Amos | Add OpenAPI 3.1 support, new attributes, schema generation |
| Architecture, spec compliance, API design | Naomi | Spec version strategy, builder patterns, breaking changes |
| Code review | Naomi | Review PRs, check quality, spec compliance |
| Testing | Bobbie | Write tests, find edge cases, verify generated specs |
| Docs, samples, README, NuGet | Alex | Update README, enhance FunctionApp1 sample, usage examples |
| Scope & priorities | Naomi | What to build next, trade-offs, decisions |
